...
describe("storage artifact commands", () => {
  it.each(["convex", "airtable", "google-sheets"] as const)("generates a non-destructive %s plan", (provider) => {
    const first = generateStoragePlan(provider, "seo-growth", "production", "2026-08-02T12:00:00.000Z");
    const second = generateStoragePlan(provider, "seo-growth", "production", "2026-08-02T12:00:00.000Z");
  ...
  it("blocks verification when native evidence misses a resource", () => {
    ...
    const plan = generateStoragePlan("convex", "seo-growth", "production", "2026-08-02T12:00:00.000Z");
